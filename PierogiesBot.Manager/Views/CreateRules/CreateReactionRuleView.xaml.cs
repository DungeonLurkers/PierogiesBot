...
{
    public partial class CreateReactionRuleView
    {
        public CreateReactionRuleView(CreateReactRuleViewModel viewModel)
        {
            InitializeComponent();
            ViewModel = viewModel;
        ...
        private void WhenActivated(CompositeDisposable disposable)
        {
            ...
            ReactionsDataGrid.ItemsSource = ViewModel.Reactions;
